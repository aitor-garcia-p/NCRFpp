...
def load_egunkaria_test_data():
    path = "C:\\Users\\agarciap\\Data\\DATASETS\\NCRFpp_tests\\TEST_named_ent_eu.test.ixaAlike"
...
if __name__ == '__main__':
    ...
    decode_results, pred_scores = label_input(input_lines, model_dir, model_name, nbest=None)
    print(tokens)
